...
class RippleStatus extends StatefulWidget {
  const RippleStatus({Key? key}) : super(key: key);

  @override
  State<RippleStatus> createState() => _RippleStatusState();
}

class _RippleStatusState extends State<RippleStatus> {

...
class ApecoinStatus extends StatefulWidget {
  const ApecoinStatus({Key? key}) : super(key: key);

  @override
  State<ApecoinStatus> createState() => _ApecoinStatusState();
}

class _ApecoinStatusState extends State<ApecoinStatus> {
   int currentIndex = 0;
  late PageController _pageController;
  List<StatusModel> bitcoinlist = [
    StatusModel(
      imageUrl: 'assets/images/APE.png'),
    StatusModel(
    imageUrl: 'assets/images/APE.png'),
  ];

...
class NearStatus extends StatefulWidget {
  const NearStatus({Key? key}) : super(key: key);

  @override
  State<NearStatus> createState() => _NearStatusState();
}

class _NearStatusState extends State<NearStatus> {

     int currentIndex = 0;
  late PageController _pageController;
  List<StatusModel> bitcoinlist = [
    StatusModel(
      imageUrl: 'assets/images/near_pro.png'),
  ];
   ...
   return Scaffold(
     backgroundColor: textColor100,
      ...
      statusBarBrightness: Brightness.dark
        ...
        title: const Text('Near Protocol',
        style: TextStyle(
          color: background,

...
class TetherStatus extends StatefulWidget {
  const TetherStatus({Key? key}) : super(key: key);

  @override
  State<TetherStatus> createState() => _TetherStatusState();
}

class _TetherStatusState extends State<TetherStatus> {
  int currentIndex = 0;

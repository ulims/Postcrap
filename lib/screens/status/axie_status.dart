...
class AxieStatus extends StatefulWidget {
  const AxieStatus({Key? key}) : super(key: key);

  @override
  State<AxieStatus> createState() => _AxieStatusState();
}

class _AxieStatusState extends State<AxieStatus> {

    int currentIndex = 0;
  late PageController _pageController;
  List<StatusModel> bitcoinlist = [
    StatusModel(
      imageUrl: 'assets/images/AXS.png'),
  ];
  ...
  return Scaffold(
     backgroundColor: textColor100,
      ...
      statusBarBrightness: Brightness.dark
        ...
        title: const Text('Axie Infinity',
        style: TextStyle(
          color: background,

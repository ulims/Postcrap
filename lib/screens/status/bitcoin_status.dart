...
class BitcoinStatus extends StatefulWidget {
  const BitcoinStatus({Key? key}) : super(key: key);

  @override
  State<BitcoinStatus> createState() => _BitcoinStatusState();
}

class _BitcoinStatusState extends State<BitcoinStatus> {
  int currentIndex = 0;

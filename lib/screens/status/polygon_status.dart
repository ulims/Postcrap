...
class PolygonStatus extends StatefulWidget {
  const PolygonStatus({Key? key}) : super(key: key);

  @override
  State<PolygonStatus> createState() => _PolygonStatusState();
}

class _PolygonStatusState extends State<PolygonStatus> {
   int currentIndex = 0;
  late PageController _pageController;
  List<StatusModel> bitcoinlist = [
    StatusModel(
      imageUrl: 'assets/images/Poly.png'),
    StatusModel(
    imageUrl: 'assets/images/Poly.png'),
    StatusModel(
    imageUrl: 'assets/images/Poly.png'),
      ...
      statusBarBrightness: Brightness.dark
        ...
        itemBuilder: ((context, index) {
          return Padding(
            ...
            Image.asset(bitcoinlist[index].imageUrl),
            ],
            ),
          );
        })),
